...
function owlRespond(text){
  ...
  else if(L.indexOf("!admin")>=0){admin=true;r="🛠 Команды: !баланс • !выдай кредитов/гемов/ур/всё [N] • !сброс • !event • !save"}
